...
export default function Header() {
  return (
    <header className="flex justify-center text-mainGray font-medium">
      <nav className="flex justify-between items-center max-w-screen-2xl w-full p-5">
        ...
        <button className="bg-gradient-to-tr from-primary to-zinc-400 shadow-inner text-black rounded-full font-semibold px-10 py-2">
          Contact
        </button>
      </nav>
    </header>
